    ...
    <motion.div
      ...
      className="home__data">
        <motion.h1  className="home__title">
          <motion.span variants={scrollToRight}>T</motion.span> 
          <motion.span variants={scrollToRight}>o</motion.span> 
          <motion.span variants={scrollToRight}>n</motion.span> 
          <motion.span variants={scrollToRight}>y</motion.span> 
          <motion.span >{' '}</motion.span> 
          <motion.span variants={scrollToRight}>O</motion.span> 
          <motion.span variants={scrollToRight}>s</motion.span> 
          <motion.span variants={scrollToRight}>i</motion.span> 
          <motion.span variants={scrollToRight}>j</motion.span> 
          <motion.span variants={scrollToRight}>o</motion.span> 
