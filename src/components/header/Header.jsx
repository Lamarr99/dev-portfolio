        ...
        <nav className="nav container">
            ...
            variants={linkItem}>
                <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <path fill={`var(--hover-color)`} d="M46.667,28.333H22.5c-6.895,0-12.5,5.604-12.5,12.5c0,6.896,5.605,12.5,12.5,12.5h24.167v-6.666H22.5
	                c-3.216,0-5.833-2.617-5.833-5.834c0-3.216,2.617-5.833,5.833-5.833h24.167V28.333z"/>
                    <path fill={`var(--hover-color)`} d="M53.333,65H77.5c3.216,0,5.833-2.617,5.833-5.833c0-3.217-2.617-5.834-5.833-5.834H53.333v-6.666H77.5
                ...
                <motion.ul className='nav__list grid' >
                    ...
                    variants={linkItem}>
                        ...
                        onClick={() => setActiveNav('#portfolio')}>
                            <i className="uil uil-file nav__icon"></i>Portfolio
                        </a>
                    </motion.li>
                    <motion.li className="nav__item"
                    variants={linkItem}>
